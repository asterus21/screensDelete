...
def start_script(input_path: str, output_path: str) -> None:
    ...
    subprocess.run(f"unused-images.exe --help-path {input_path} --output-path {output_path}", shell=True)
...
def main() -> None:
    ...
    print("enter the input path (e.g. D:/gitbash/help): ", end='')
    input_path = input(str())
    print("enter the output path (e.g. ./): ", end='')
    output_path = input(str())
